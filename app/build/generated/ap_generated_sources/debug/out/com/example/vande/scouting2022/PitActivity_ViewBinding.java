...
public class PitActivity_ViewBinding implements Unbinder {
  ...
  public PitActivity_ViewBinding(PitActivity target, View source) {
    ...
    target.pitPowerCellBottomInputLayout = Utils.findRequiredViewAsType(source, R.id.pit_powerCellBottom_input_layout, "field 'pitPowerCellBottomInputLayout'", TextInputLayout.class);
    ...
    target.pitPowerCellTopInput = Utils.findRequiredViewAsType(source, R.id.pit_powerCellTop_input, "field 'pitPowerCellTopInput'", TextInputEditText.class);
    ...
    target.pitControlPanelRadioGrp = Utils.findRequiredViewAsType(source, R.id.pit_controlPanel_RadiobtnGrp, "field 'pitControlPanelRadioGrp'", RadioGroup.class);
