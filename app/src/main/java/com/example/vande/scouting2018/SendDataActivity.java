                    ...
                    if (files != null) {
                        try {
                            ...
                            if(type.contains("Match")) {
                                fileOutputStream.write(("teamNumber,matchNumber,initiationLine,autonInner,autonOuter,autonBottom,teleopInner," +
                                        "teleopOuter,teleopBottom,pickupLocation,controlPanel,climb,defense,fouls,scouterInitials\n").getBytes());
                            } else {
                                fileOutputStream.write(("teamNumber,teleopPreference,avgPowerCellTop,avgPowerCellBottom,controlPanel,climb,programmingLanguage," +
                                        "weight,stormTrooperShots,extraComments\n").getBytes());
                            }
